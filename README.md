...
The Debian package repository for [charly](https://github.com/opencharly/charly) — the OpenCharly CLI and its composed toolchain, packaged as `.deb` for `amd64` and `arm64`.
...
```sh
curl -fsSL https://opencharly.github.io/charly-debian/charly.gpg | gpg --dearmor -o /etc/apt/keyrings/charly.gpg
echo "deb [signed-by=/etc/apt/keyrings/charly.gpg] https://opencharly.github.io/charly-debian/ stable main" > /etc/apt/sources.list.d/charly.list
apt update
apt install charly
```
...
- amd64: `https://opencharly.github.io/charly-debian/pool/main/c/charly/charly-amd64.deb`
- arm64: `https://opencharly.github.io/charly-debian/pool/main/c/charly/charly-arm64.deb`
